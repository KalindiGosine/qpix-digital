module clked_comparator 
	#(parameter VDDA = 1.8,
	parameter VOFFSET = 0.470)             // unsure what this is-- 
	...
	input logic clock		       // sampling clock, nom 50MHz
...
// output assignment for clked comparator. output can only be high when Clk is
// high & csa_out is above threshold
always_comb begin
